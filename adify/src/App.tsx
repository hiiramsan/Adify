    ...
    <div className="bg-gray-950 min-h-screen">
      ...
      <div className="flex flex-col items-center justify-center text-center text-white py-20">
        ...
        <div className="flex justify-center space-x-4">
          <button
            type="button"
            className="flex items-center justify-center w-48 text-black bg-white border border-black h-14 rounded-xl cursor-pointer"
          >
            <div className="mr-3">
          ...
          <button
            type="button"
            className="flex items-center justify-center w-48 text-white bg-black rounded-lg h-14 border border-white"
          >
            <div className="mr-3">
        ...
        <div className="flex justify-center mt-16">
          <Iphone15Pro className="w-[300px] md:w-[430px]" src="/mockup.png" />
        </div>
      </div>
    </div>
  );
